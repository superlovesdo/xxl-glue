...
-- ----------------------------
--  Table structure for `xxl_glue_biz`
-- ----------------------------
DROP TABLE IF EXISTS `xxl_glue_biz`;
CREATE TABLE `xxl_glue_biz` (
...
-- ----------------------------
--  Records of `xxl_glue_user`
-- ----------------------------
BEGIN;
INSERT INTO `xxl_glue_user` VALUES ('1', 'admin', '123456', '1');
COMMIT;
