 ...
 *
 * @author BK 2015-8-28 10:37:43
 */
public abstract class BkZkClient implements Watcher {
    private static final Logger logger = LoggerFactory.getLogger(BkZkClient.class);
    ...
    public BkZkClient(String zkserver) {
        ...
        if (zookeeper != null) {
            ...
            try {
                if (INSTANCE_INIT_LOCK.tryLock(2, TimeUnit.SECONDS)) {
                    ...
                    logger.info(">>>>>>>>> BkZkClient.zookeeper connnect success.");
                }
