...
CREATE TABLE `sv_execution_unit`
(
...
CREATE TABLE `sv_execution_unit_log`
(
  `id`          int(11) NOT NULL AUTO_INCREMENT,
  `glue_id`     int(11) NOT NULL COMMENT 'PK',
...
INSERT INTO `sv_project`
VALUES ('1', 'demo_project', 'DEMO项目');

INSERT INTO `sv_execution_unit`
VALUES ('1', '1', 'demo_project.DemoGlueHandler01', '示例场景01：托管 “配置信息”',
        ...
        '2017-05-31 22:39:32', '2017-05-31 23:00:50'),
       ('2', '1', 'demo_project.DemoGlueHandler02', '示例场景02：托管 “静态方法”',
        ...
        '2017-05-31 22:39:47', '2017-05-31 23:02:20'),
       ('3', '1', 'demo_project.DemoGlueHandler03', '示例场景03：托管 “动态服务”',
