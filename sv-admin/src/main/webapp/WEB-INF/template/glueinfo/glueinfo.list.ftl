            ...
            <div class="modal-body">
                <form class="form-horizontal form" role="form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7"><input type="text" class="form-control" name="name"
                                                     placeholder="请输入“GLUE名称”" maxlength="50"></div>
                    </div>
                    <div class="form-group">
                        <label for="lastname" class="col-sm-3 control-label">描述<font color="red">*</font></label>
                        <div class="col-sm-7"><input type="text" class="form-control" name="about" placeholder="请输入“描述”"
                                                     maxlength="20"></div>
                    </div>
...
package com.sv.example.handler;

import com.sv.core.handler.GlueHandler;
            ...
            <div class="modal-body">
                <form class="form-horizontal form" role="form">
                    ...
                    <div class="form-group">
                        <label for="lastname" class="col-sm-3 control-label">GLUE<font color="red">*</font></label>
                        <div class="col-sm-7"><input type="text" class="form-control" name="name"
                                                     placeholder="请输入“GLUE名称”" maxlength="50" readonly></div>
                    </div>
                    <div class="form-group">
                        <label for="lastname" class="col-sm-3 control-label">描述<font color="red">*</font></label>
                        <div class="col-sm-7"><input type="text" class="form-control" name="about" placeholder="请输入“描述”"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal form" role="form">
                    <div class="form-group">
                        <label for="lastname" class="col-sm-3 control-label">Which App?<font
                                    color="black">*</font></label>
                        <div class="col-sm-7"><input type="text" class="form-control" name="appNames"
                                                     placeholder="请输入待清理GLUE缓存项目的AppName，多个逗号分隔，为空则全站清理。"
                                                     maxlength="20"></div>
                    </div>
