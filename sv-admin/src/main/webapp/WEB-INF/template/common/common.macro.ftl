<#macro commonName>Suport Vehicle</#macro>
<#macro commonProjectName><b>BK</b>GLUE</#macro>
<#macro commonStyle>
...
<#macro commonFooter >
    ...
    Powered by <b>sv</b> 1.3
    <div class="pull-right hidden-xs">
    <strong>Copyright &copy; 2015-${.now?string('yyyy')} &nbsp;
    <a href="https://github.com/xuxueli/sv" target="_blank">github</a>&nbsp;
